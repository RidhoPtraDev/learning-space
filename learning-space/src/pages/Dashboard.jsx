...
// - URL lengkap (hasil upload lewat dashboard admin): http://localhost:5000/uploads/kelas/xxx.png
  ...
  return (
    <div style={s.layout}>
      ...
      <main style={s.main}>
        ...
        {loading && (
          <div style={{ textAlign: 'center', color: '#888', padding: '40px' }}>Memuat data kelas...</div>
        )}
...
const s = {
  ...
  // Right panel — Disesuaikan dengan Kelas Favorit
